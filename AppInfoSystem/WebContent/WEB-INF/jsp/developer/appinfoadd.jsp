  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
	  ...
	  <!-- <div class="item form-group">
           ...
           <div class="clearfix"></div>
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath }/pre/appinfo/appinfoaddsave.html" method="post" enctype="multipart/form-data">
          <div class="item form-group">
